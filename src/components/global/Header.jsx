...
export default function Header({ setArray, array }) {
    ...
    const isJustArticle = /(^|\/)(articles)(\/|$)/.test(pathname);
        ...
        <header className='px-4'>
                ...
                <div className='flex-1 flex justify-end items-center gap-10'>
                    ...
                    <div className='h-[68px] lg:flex hidden items-stretch bg-white box-shadow p-1 rounded-full gap-2 2xl:max-w-[800px] max-w-[460px] flex-1'>
                        <Link
                            to='/articles'
                            className={
                                `h-[59px] px-10 text-[20px] rounded-full flex justify-center items-center text-center cursor-pointer flex-1 ` +
                                (isArticlesActive
                                    ? "bg-darkblue/20 text-darkblue font-semibold"
                                    : "")
                            }
                        >
                            Articles
            ...
            {(isJustArticle || isJustUser) && (
                <div className='lg:mt-[68px] md:mt-14 mt-7 max-w-[1692px] mx-auto flex xl:gap-3 gap-2 '>
                    ...
                    <Link
                        to={isArticlesActive ? "/create-article" : "/add-user"}
                        className='md:p-4 p-3.5 flex items-center justify-center bg-pink1 rounded-full cursor-pointer box-shadow'
                    >
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='28'
            ...
            <div className='h-[67px] flex lg:hidden items-stretch bg-white box-shadow p-1 rounded-full gap-2 flex-1 mt-[28px]'>
                <Link
                    to='/articles'
                    className={
                        `h-[59px] px-10 text-lg leading-normal rounded-full flex justify-center items-center text-center cursor-pointer flex-1 ` +
                        (isArticlesActive
                            ? "bg-darkblue/20 text-darkblue font-semibold"
                            : "")
                    }
